...
\begin{itemize}
    ...
    \item The reactor \nuebar{} emitted spectra and rates
        ...
        and energy per fission from XYZ.\todo{citations for reactor spectra}
\end{itemize}
...
\begin{itemize}
    \item The detector response matrix was estimated using the toy Monte Carlo
        described in \todo{cref section on LBNL ToyMC} \cite{lbnl_toymc}.
    ...
    \item The expected true IBD spectrum was computed from
        ...
        the IBD cross section,\todo{cite IBD cross section}
