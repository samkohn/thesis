...
$a$ quantifies the impact due to the non-pointlike nature
...
then the IBD selection efficiency for that AD may be affected,
which would result in a bias in the measurement of \thetaot.
...
how close is that value to the original $E_{\text{true}}$?
