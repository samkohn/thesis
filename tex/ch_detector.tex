...
\todo{move some of this text to the intro}
...
If the neutron captures on a Hydrogen (nH) nucleus present as part of
...
from the master trigger board\todo{Ask Kam-Biu about use of prescaled triggers}.
...
%TODO move to either Intro or Conclusions chapter
