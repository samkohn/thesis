...
their contributions were summed over each AD:
\begin{equation}\label{eq:pull_near_contrib}
    \delta\chi^2_\text{near AD} = \sum_b \frac{\nu^2_{(b)}}{\tilde{\sigma}^2_{(b)}}.
\end{equation}
...
16 parameters plus the 4 data-to-model comparison terms
...
\begin{table}[ht]
    ...
    \caption[Significant contributions to final $\chi^2$]{
        ...
        or \SI{99.93}{\percent} of the total value of the minimum $\chi^2$.
    }
