...
The dependence of the prompt energy cut efficiency on the oscillation parameters
is represented by $\delta_{p,i}(\thetaot, \dmee)$ (\cref{subsec:prompt_energy}).
...
This effect is separate from the direct impact on prompt energy efficiency
due to oscillations represented by $\delta_{p,i}$.
