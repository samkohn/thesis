...
\todo{verify these are the correct citations.}
...
\begin{table}[ht]
    ...
    \begin{tabular}[t]{lSSSSS}
        ...
        & \SI{2}{\MeV} & \SI{2.5}{\MeV} & \SI{3}{\MeV} & \SI{3.5}{\MeV}
                & \SI{4}{\MeV} \\
        \cmidrule(lr){2-6}
        Isotope & \multicolumn{5}{c}{Nonequilibrium correction [\%]} \\
        \midrule
...
\end{equation}
\todo[inline]{Plot(s) of reactor spectra}
\todo[inline]{Cross section discussion and plot}
