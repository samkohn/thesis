...
in the oscillation equation. \todo{Reference osc. eq. in intro}
...
%TODO overview of calibration sources: ACUs, SPN, SPE, alpha & gamma peaks from singles

Sources are deployed weekly during special calibration runs.
% TODO describe the z positions and patterns etc. used during the weekly calibrations
...
%TODO mention the cross-check with LED
...
the amplification and digitization process \cite{ngd2016}: %TODO cit E. H. Bellamy et
% al., Nucl. Instr. Meth. A 339, 468 (1993) (ref. 35 from nGd long paper)
...
%TODO describe Co-60 calibration
