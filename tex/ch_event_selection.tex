...
\begin{figure}
    %\includegraphics[width=\textwidth]{ch_event_selection/top_ring_flashers}
    \missingfigure{Top ring flashers}
    \caption{
        Position distribution of single events in EH3-AD3
        which pass the nominal and 2-inch flasher cuts,
        have $E > \SI{0.7}{\MeV}$, and pass the usual muon vetos.
        The top-ring flasher cut
        vetoes all events to the right of the red dashed line (left)
        or outside the red dashed circle (right).
    }
...
A grid of correction values in (\thetaot{}, \dmee{}) parameter space
