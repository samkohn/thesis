...
\todo[inline]{Explain the EH3 decrease and EH1 increase in $\varepsilon_\mu$}
...
to characterize the remaining so-called residual flashers \todo{rate wrt nominal flashers?}
...
$\sim\SI{0.02}{\percent}$ of true IBDs in each AD \cite{nh2021technote}.
...
based on the \fold{1} event rate of $\sim\SI{20}{\Hz}$,
was $\sim\SI{50000}{\us}$.
...
\todo{Update name of MC if necessary}
...
The near-hall ADs were sensitive by a factor of $\sim30$.

\begin{figure}
    \centering
    \missingfigure{Beda's DT efficiency plot with the correct values}
    \caption[DT efficiency with full statistical uncertainty]{
        ...
        The uncertainties confirm that the AD-to-AD variations
...
the discrepancy of $\sim0.06$ between EH3-AD4's efficiency and the near-hall average
