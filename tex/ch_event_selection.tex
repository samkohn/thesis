...
\label{subsec:radn}
\todo[inline]{Radiogenic neutron background section}
...
pos = ht
    ...
    & {Uncertainty (\%)} \ML
    Prompt energy cut eff. & 0.10\tmark[a] \tabularnewline
    Delayed energy cut eff. & 0.20 \NN
    Distance-time (DT) cut eff. & 0.50 \NN
    Target proton number & 0.37 \NN
    \addlinespace
    Total AD-uncorrelated uncertainty & 0.66\tmark[a] \tabularnewline\bottomrule
}
