...
\begin{figure}
    ...
    \caption{
        ...
        top right: outside flashers;
        bottom: hidden flashers.
        The vast majority of the hidden flasher events
        within $R^2 < \SI{1}{\m\squared}$
        were single events and thus did not impact the IBD selection efficiency.
    }
