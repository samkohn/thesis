...
\begin{figure}
    \begin{subfigure}{0.49\textwidth}
        %TODO produce plots with **all** double coincidences
        \includegraphics[width=\textwidth]{ch_event_selection/double_coincs_EH1_AD1}
        \caption{All \fold{2} coincidences from EH1-AD1}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\textwidth]{ch_event_selection/test}
        \caption{All \fold{2} coincidences from EH3-AD1} %TODO
    \end{subfigure}
    \caption{}
    \label{fig:double_coinc_eh1ad1}
\end{figure}
...
\Cref{fig:double_coinc_eh1ad1} shows the prompt and delayed energy
...
\begin{figure} %TODO generate full plot
    \begin{subfigure}{0.49\textwidth}
        \includegraphics[width=\textwidth]{ch_event_selection/after_DT_cut_EH1_AD1}
        \caption{}
    \end{subfigure}
    \begin{subfigure}{0.49\textwidth} %TODO make EH3-AD1
        \includegraphics[width=\textwidth]{ch_event_selection/after_DT_cut_EH1_AD1}
        \caption{}
    \end{subfigure}
    \caption{Coincidence distance vs. coincidence time
    for events in EH1-AD1 and EH3-AD1.}
    \label{fig:dr_vs_dt}
\end{figure}
...
This cut is known as the D-T cut and the line has the equation
