...
the rare unstable isotopes \li, \he, and \boron{} (\cref{subsec:li9}).
...
The residual \li, \he, and \boron events in the dataset are characterized
...
\cref{eq:mult_eff_ap}: \todo{Plots of multiplicity efficiency vs time}
