...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{ch_introduction/solar_spectrum}
    \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{ch_introduction/sno_salt}
    \caption{
...
Due to the interaction with the highly dense matter in the solar interior,
solar neutrinos
have an entirely different oscillation phenomenology from
accelerator, reactor and atmospheric neutrinos.
The theoretical framework for neutrino oscillation
accommodates both (ordinary) vacuum oscillations
as well as the (solar) oscillations in matter.
...
\begin{figure}
    \includegraphics[width=0.5\textwidth]{ch_introduction/kamioka_atmo_spec}
    \caption{
...
If so, an additional two parameters, the Majorana phases,
...
\todo{Update ``this work'' if needed}
...
and includes DUNE in the United States \todo{Which DUNE pub to cite?}
...
The new generation of reactor experiments
