...
describe the modern theoretical understanding of neutrino oscillations
(\cref{sec:osc_intro});
...
Previous results published by the Daya Bay experiment
will be briefly summarized in \cref{sec:previous_results}.
...
\begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{ch_introduction/sno_first}
    \includegraphics[width=0.49\textwidth]{ch_introduction/sno_salt}
    \caption{
...
The next generation of reactor experiments
